...
import com.example.dalportal.ui.professorportal.CalendarUtils.formattedShortTime
import java.time.LocalTime


class HourAdapter( context: Context?, hourEvents: kotlin.collections.List<HourEvent?>?) :
